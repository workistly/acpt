...
Produced 2026-08-27 by an 8-agent mapping pass over the full codebase. Facts below were read from code; anything uncertain is phrased as such. Unverified *issue* leads live in [REVIEW-LEADS.md](REVIEW-LEADS.md).
